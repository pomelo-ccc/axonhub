...
export function RequestDetailContent({ requestId, projectId, previewRequest, isPreviewStreaming = false }: RequestDetailContentProps) {
  ...
  return (
    <div className='space-y-8'>
      <Card className='border border-border/70 bg-card/92 shadow-none'>
        <CardHeader className='pb-2'>
          <CardTitle className='flex items-center justify-between'>
            <div className='flex items-center gap-2'>
              <div className='flex h-7 w-7 items-center justify-center rounded-xl border border-border/70 bg-muted/35'>
                <DashboardIcon className='h-3.5 w-3.5 text-foreground' />
              </div>
        ...
        <CardContent>
          <div className='grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3'>
            <div className='flex items-center justify-between gap-2 rounded-xl border border-border/60 bg-muted/20 px-3 py-2.5'>
              ...
              <p className='rounded-md border border-border/60 bg-background/80 px-2 py-0.5 font-mono text-xs'>
            ...
            <Card className='border border-border/70 bg-card/92 shadow-none'>
              <CardHeader className='pb-2'>
                <CardTitle className='flex items-center justify-between'>
                  ...
                  <Badge variant='outline' className='border-border/70 bg-muted/35'>
              ...
              <CardContent>
                <div className='grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-5'>
                  <div className='flex flex-col justify-center rounded-xl border border-border/60 bg-muted/20 px-2.5 py-2.5'>
                  ...
                  <div className='flex flex-col justify-center rounded-xl border border-border/60 bg-muted/20 px-2.5 py-2.5'>
                    ...
                    <div className='mt-1'>
                      <div className='flex items-center justify-between'>
                        ...
                        {hasReadCache && (
                          <Badge variant='outline' className='h-4 border-emerald-500/20 bg-emerald-500/8 px-1 text-[10px] text-emerald-700 dark:text-emerald-300'>
                            {cacheHitRate}%
                          </Badge>
                        )}
                      </div>
                  ...
                  <div className='flex flex-col justify-center rounded-xl border border-border/60 bg-muted/20 px-2.5 py-2.5'>
                    ...
                    <div className='mt-1'>
                      <div className='flex items-center justify-between'>
                        ...
                        {hasWriteCache && (
                          <Badge variant='outline' className='h-4 border-sky-500/20 bg-sky-500/8 px-1 text-[10px] text-sky-700 dark:text-sky-300'>
                            {writeCacheRate}%
                          </Badge>
                        )}
                      </div>
      ...
      <Card className='border border-border/70 bg-card/92 shadow-none'>
        <CardContent className='p-0'>
          <Tabs defaultValue='request' className='w-full'>
            <div className='border-b border-border/70 bg-muted/10 px-6 pt-6'>
            ...
            <TabsContent value='request' className='space-y-6 p-6'>
              ...
              {request.requestHeaders && (
                <div className='space-y-4'>
                  ...
                  <div className='h-[300px] w-full overflow-auto rounded-xl border border-border/60 bg-muted/15 p-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='h-[500px] w-full overflow-auto rounded-xl border border-border/60 bg-muted/15 p-4'>
                ...
                <div className='mt-6'>
                  <TabsContent value='preview' className='mt-0 transition-all focus-visible:outline-none'>
                    {hasPreviewData || isLive ? (
                      ...
                      <div className='flex h-[400px] w-full items-center justify-center rounded-xl border border-border/60 bg-muted/15'>
                        <div className='space-y-4 text-center'>
                  ...
                  <TabsContent value='json' className='mt-0 focus-visible:outline-none'>
                    {hasResponseBody ? (
                      ...
                      <div className='flex h-[500px] w-full items-center justify-center rounded-xl border border-border/60 bg-muted/15'>
                        <div className='space-y-4 text-center'>
                          <div className='border-primary mx-auto h-8 w-8 animate-spin rounded-full border-b-2'></div>
                          <p className='text-muted-foreground text-sm'>{t('common.loading')}...</p>
                        </div>
              ...
              {isExecutionsLoading ? (
                ...
                <div className='space-y-6'>
                  {executions.edges.map((edge: any, index: number) => {
                    ...
                    return (
                      <Card key={execution.id} className='border border-border/60 bg-muted/15 shadow-none'>
                        <CardHeader className='pb-4'>
                          <div className='flex items-center justify-between'>
                            <h5 className='flex items-center gap-2 text-base font-semibold'>
                              <div className='flex h-6 w-6 items-center justify-center rounded-full border border-border/70 bg-background/85 text-xs font-bold text-foreground'>
                                {index + 1}
                              </div>
                        ...
                        <CardContent className='space-y-6'>
                          ...
                          {(execution.requestHeaders || execution.requestBody) && (
                            <div className='flex justify-end'>
                              <Button variant='outline' size='sm' onClick={() => showExecutionCurlPreview(execution.requestHeaders, execution.requestBody, execution.channel, execution.format)}>
                                <Terminal className='mr-2 h-4 w-4' />
                                {t('requests.actions.copyCurl')}
                              </Button>
                            </div>
                          ...
                          {execution.requestHeaders && (
                            <div className='space-y-3'>
                              ...
                              <div className='h-64 w-full overflow-auto rounded-xl border border-border/60 bg-background/85 p-3'>
                          ...
                          {execution.requestBody && (
                            <div className='space-y-3'>
                              ...
                              <div className='h-80 w-full overflow-auto rounded-xl border border-border/60 bg-background/85 p-3'>
